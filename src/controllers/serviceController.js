...
export const createServiceGroup = async (req, res) => {
  ...
  if (req.user.role !== "secretary" ) {
    return res.status(403).json({ message: "Only secretaries can create service groups" });
  }
  ...
  try {
    ...
    res.status(500).json({ message: "Failed to create service group", error: err.message });
  }
};
...
export const updateServiceGroup = async (req, res) => {
  ...
  if (req.user.role !== "secretary" ) {
    return res.status(403).json({ message: "Only secretaries can update service groups" });
  }
  ...
  try {
    ...
    res.status(500).json({ message: "Failed to update service group", error: err.message });
  }
};
...
export const deleteServiceGroup = async (req, res) => {
  ...
  if (req.user.role !== "secretary" ) {
    return res.status(403).json({ message: "Only secretaries can delete service groups" });
  }
  try {
    const deleted = await Service.findByIdAndDelete(groupId);
    if (!deleted) return res.status(404).json({ message: "Service group not found" });

    res.status(200).json({ message: "Service group deleted successfully" });
  } catch (err) {
    res.status(500).json({ message: "Failed to delete service group", error: err.message });
  }
};
...
export const addServiceItem = async (req, res) => {
  ...
  if (req.user.role !== "secretary" ) {
    return res.status(403).json({ message: "Only secretaries can add services" });
  }
  ...
  try {
    ...
    res.status(500).json({ message: "Failed to add service item", error: err.message });
  }
};
...
export const updateServiceItem = async (req, res) => {
  ...
  if (req.user.role !== "secretary") {
    return res.status(403).json({ message: "Only secretaries can update services" });
  }
  ...
  try {
    ...
    res.status(500).json({ message: "Failed to update service item", error: err.message });
  }
};
...
export const deleteServiceItem = async (req, res) => {
  ...
  if (req.user.role !== "secretary") {
    return res.status(403).json({ message: "Only secretaries can delete services" });
  }
  ...
  try {
    ...
    res.status(200).json({ message: "Service item deleted successfully", group });
  } catch (err) {
    res.status(500).json({ message: "Failed to delete service item", error: err.message });
  }
};